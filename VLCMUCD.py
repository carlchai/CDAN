...
if __name__ == '__main__':
    ...
    args.num_classes = 2
    args.output_dir = 'VLCMUCD/ablation_wihoutcan'
    trainset = get_VL_CMU_CD_Raw(args, train=True)
    testset = get_VL_CMU_CD_Raw(args, train=False)
    ...
    Train()
    model_path = "VLCMUCD/ablation_wihoutcan/best.pth"
    save_imgs_dir = "VLCMUCD/ablation_wihoutcan_img"
